...
with open(os.path.join("..","songs","songs_1.txt"), 'r', encoding='utf-8') as f:
    songs_1 = [song[:-1] for song in f.readlines()]

with open(os.path.join("..","songs","songs_2.txt"), 'r', encoding='utf-8') as f:
...
df_1 = pd.read_csv(os.path.join("..","grids",f"grids_1","data.csv"))
df_2 = pd.read_csv(os.path.join("..","grids",f"grids_2","data.csv"))
dfs = [df_1,df_2]
...
def load_grid(grid_idx:int):
    ...
    grid = pd.read_csv(os.path.join("..","grids",f"grids_{round_n+1}",f'{grid_idx}.csv'),
                       sep=';',header=None)
...
with dpg.font_registry():
    default_font = dpg.add_font(os.path.join("..","fonts","JetBrainsMonoNL-Regular.ttf"), 30)
    input_font   = dpg.add_font(os.path.join("..","fonts","JetBrainsMonoNL-Regular.ttf"), 45)
    list_font    = dpg.add_font(os.path.join("..","fonts","JetBrainsMonoNL-Italic.ttf" ), 23)
    grid_font    = dpg.add_font(os.path.join("..","fonts","JetBrainsMonoNL-Regular.ttf"), 25)
